        ...
        <div className="flex flex-wrap items-end justify-between gap-6">
          ...
          <div className="flex gap-3">
            <button
              ...
              disabled={!canPrev}
              aria-label="Previous"
              className="grid h-12 w-12 place-items-center rounded-full glass transition-all hover:bg-white/10 disabled:opacity-30"
            >
              ...
              >
                <div className="gradient-border h-full rounded-3xl p-6 text-center">
                  ...
                  <div className="mt-1 overflow-hidden">
                    <p className="text-sm text-white/55 transition-colors duration-300 group-hover:text-brand-teal">
                      {s.role}
                    </p>
                  </div>
                  <Quote className="mx-auto mt-4 h-5 w-5 text-white/15 transition-colors group-hover:text-brand-teal/50" />
                </div>
              </motion.div>
            ))}
          </div>
